        ...
        <>
            ...
            <table className="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th>Tuổi</th>
                    <th>Lớp học</th>
                    {account && (account.role === "ADMIN") && (<th>Xoá</th>)}
                    <th>Chi tiết</th>
                    {account && (account.role === "ADMIN") && (<th>Sửa</th>)}
                </tr>
                </thead>
                <tbody>
                {
                    listStudent && listStudent.map((student, index) => (
                        <tr key={student.id}>
                            ...
                            <td>
                                {account &&
                                    <Link to={'/students/detail/' + student.id} className="btn btn-sm btn-success">Chi
                                        tiết</Link>}
                            </td>

                            {account && ((account.role === "ADMIN") && (
                                <td><Link to={'/students/edit/' + student.id} className="btn btn-sm btn-primary">Sửa</Link>
                                </td>))}
